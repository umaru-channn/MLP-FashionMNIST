...
CNNModel::CNNModel()
: 
m_conv1(32, 32, 3, 3, 8),      // 32×32×3 → 32×32×8
m_pool1(2),                     // 32×32×8 → 16×16×8
m_conv2(16, 16, 8, 3, 16),     // 16×16×8 → 16×16×16
m_pool2(2),                     // 16×16×16 → 8×8×16
m_fcl1(8 * 8 * 16, 128),       // 1024 → 128
m_fcl2(128, 10)                 // 128 → 10
{
}
...
// CIFAR-10 のクラス名を取得して result に追加する
result.push_back(CIFAR10Loader::GetClassName(id));
}
// 変換したクラス名リストを返す
return result;
}
